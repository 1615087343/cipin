...
public class WordCount {
	public static void main(String[] args) throws Exception{
		...
		String s;
		String[] a;//存放统计的单词的频率
		Map<String,Integer> map=new TreeMap<String,Integer>();//集合用键值对的方式存取数据
		...
		case 1:
			...
			a=tj.oneword(map,str); //通过方法调用来实现单个单词的频率
		...
		case 2:		
			...
			tj1.gaopin(map, k);	//通过方法调用来实现单个单词的频率
			break;
		case 3:
